<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"10px 5px","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  white-space: nowrap;
				  				  line-height: 70px;
				  				  background-image: url(http://codegen.caihongy.cn/20220726/bd28bed57c07435ab63ec9a9b5eb4c5c.png);
				  				  position: relative;
				  				  height: 70px;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #333;
						background-image: url(http://codegen.caihongy.cn/20220726/acfdd54ed9aa4774b7c8580a3782bfe8.png);
					}
