...
public class OrdersController {
    ...
    @GetMapping("/completed-orders-by-type")
    public R getCompletedOrdersByGoodTypeChart() {
        List<Map<String, Object>> data = ordersService.selectCompletedOrdersByGoodType();
