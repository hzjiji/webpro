...
public class OrdersServiceImpl extends ServiceImpl<OrdersDao, OrdersEntity> implements OrdersService {
	...
	@Override
	public List<Map<String, Object>> selectCompletedOrdersByGoodType() {
		EntityWrapper<OrdersEntity> wrapper = new EntityWrapper<>();
		wrapper.eq("status", "已完成");
		wrapper.setSqlSelect("goodtype, SUM(buynumber) as 数量");
		wrapper.groupBy("goodtype");
		wrapper.orderBy("数量", false); // 降序排序
